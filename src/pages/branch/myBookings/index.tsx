        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <div className="mb-8">
            ...
            <p className="text-gray-600">
              View and manage your {userType === 'branch' ? 'branch' : 'practice'}'s confirmed bookings. You can cancel bookings before they start (penalties may apply within 48 hours).
            </p>
          </div>
