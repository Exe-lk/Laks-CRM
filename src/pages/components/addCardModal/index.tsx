...
const AddCardForm: React.FC<{
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const customerResponse = await fetch(`${process.env.NEXT_PUBLIC_SITE_URL || ''}/api/practice-card/customer-management`, {
        method: 'POST',
        headers: {
      ...
      const errorMessage = error?.data?.error || error?.message || 'Failed to add card. Please try again.';
