...
const PracticeRegisterForm = () => {
    ...
    const formik = useFormik({
        ...
        validate: (values) => {
            ...
            else if (!/^\d{10,15}$/.test(values.telephone)) errors.telephone = 'Enter a valid telephone number';
            if (!values.gdc) errors.gdc = 'GDC is required';
        ...
        onSubmit: async (values) => {
            ...
            try {
                // Simulate API call
                Swal.fire({
                    title: 'Practice registration completed successfully!',
                    icon: 'success',
                    ...
                    <form onSubmit={formik.handleSubmit} className="px-8 py-8 space-y-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="space-y-2 group">
                                ...
                                <input
                                    ...
                                    onChange={formik.handleChange}
                                    onBlur={formik.handleBlur}
                                    className={`w-full px-4 py-3 border-2 ${formik.errors.telephone && formik.touched.telephone ? 'border-red-500' : 'border-gray-200'} rounded-xl focus:border-[#C3EAE7] focus:ring-2 focus:ring-[#C3EAE7]/30 transition-all duration-200 outline-none hover:border-[#C3EAE7]/50 group-hover:shadow-md`}
                        ...
                        <label className="block text-sm font-semibold text-black flex items-center gap-2">
                                ...
                                <input
                                    type="text"
                                    name="gdc"
                                    value={formik.values.gdc}
                                    onChange={formik.handleChange}
                                    onBlur={formik.handleBlur}
                                    className={`w-full px-4 py-3 border-2 ${formik.errors.gdc && formik.touched.gdc ? 'border-red-500' : 'border-gray-200'} rounded-xl focus:border-[#C3EAE7] focus:ring-2 focus:ring-[#C3EAE7]/30 transition-all duration-200 outline-none hover:border-[#C3EAE7]/50 group-hover:shadow-md`}
                                    placeholder="Enter your GDC number"
                                    required
                                />
                                {formik.errors.gdc && formik.touched.gdc && (
                                    <div className="text-red-500 text-sm mt-1">{formik.errors.gdc}</div>
                                )}
