          ...
          <div className="p-8 sm:p-12 mb-12">
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-base sm:text-lg text-gray-600 max-w-4xl">
                This manual provides step-by-step instructions for dental practices to register and use the platform. 
                Learn how to post appointment requests, manage bookings, and connect with qualified locum staff.
              </p>
            </div>
          </div>
